...
- **[DevProjex](https://github.com/Avazbek22/DevProjex)**: Read-only desktop and CLI tool for selecting, filtering, previewing, and exporting structured codebase context for AI assistants, code reviews, and documentation.
